...
<head>
    ...
    <meta name="description" content="Create your Paisa Pilot account - Start tracking expenses and paper trading today.">
...
<body>
    <div class="auth-wrapper">
        <div class="auth-card">
            ...
            <p class="auth-subtitle">Start your financial journey with ₹1,00,000 virtual balance</p>
            ...
            <form class="auth-form" method="POST" action="" id="signupForm">
                <div class="form-group">
                    ...
                    <input type="text" id="username" name="username" placeholder="e.g. rahul_sharma" 
